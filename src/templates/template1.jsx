    ...
    >
      ...
      <header style={headerStyle} className={`${sectionMargin} ${sectionPadding} ${borderRadius}`}>
        ...
        <div className={`${body} ${itemMargin} text-gray-700`} style={contactStyle}>
          ...
          {(email || data.city) && data.phone && <span style={{ margin: '0 8px' }}>•</span>}
          <span style={{ marginRight: '8px' }}>
            {data.phone || "(123) 456-7890"}
          </span>
          {data.phone && linkedin && <span style={{ margin: '0 8px' }}>•</span>}
          {linkedin && (
      ...
      {projectsList.length > 0 && (
        <section aria-label="projects" className="break-inside-avoid-page">
          ...
          {projectsList.map((project, i) => (
            <div key={`project-${i}`} className="break-inside-avoid-page" style={{ ...subsectionStyle, marginBottom: "10px" }}>
